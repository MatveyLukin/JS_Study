...
function f5() {
  let out5 = out4.classList.contains("bg-orange");
...
function f6() {
  let out6 = document.querySelectorAll(".p-6");
  console.log(out6);
...
function f7() {
  for (let i = 0; i < blocks7.length; i++) {
    blocks7[i].classList.add("bg-orange"); //в чём разница между toggle&add?
  }
}
...
function f10() {
  if (div10.classList.contains("bg-orange")) {
    this.classList.toggle("div10");
  }
  else
}
